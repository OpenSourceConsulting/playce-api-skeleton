...
public class PasswordIncorrectLimitException extends AuthenticationException {
    ...
    public PasswordIncorrectLimitException(String msg, Throwable t) {
        super(msg, t);
    }

    public PasswordIncorrectLimitException(String msg) {
        super(msg);
    }
}
//end of PasswordIncorrectLimitException.java